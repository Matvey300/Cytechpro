...
df_search = pd.read_csv(
    "/Users/Matvej1/CyberPro/Python_main/Python_Data_Analytic_project/DATA/search_results.csv"
)
df_reviews = pd.read_csv(
    "/Users/Matvej1/CyberPro/Python_main/Python_Data_Analytic_project/DATA/all_reviews.csv"
)
...
# Подозрительные ASIN
sus = (
    df_features[df_features["verified_share"] < 0.8]
